...
export const Scene: React.FC<{
	...
	const { t, currentNativeLang, setCurrentNativeLang, currentForeignLang, setCurrentForeignLang} = useI18n()
	...
	return (
		<div>
			{currentNativeLang && foreignLang? (<AbsoluteFill className="bg-darkGrey">
				<Sequence
